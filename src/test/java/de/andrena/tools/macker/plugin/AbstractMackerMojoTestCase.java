...
public abstract class AbstractMackerMojoTestCase
        extends AbstractMojoTestCase
{
            ...
            throws Exception
    {
        ...
        final String exampleClassesPath = "de/andrena/tools/macker/plugin/classes";
        ...
        final String testClassesPath = "de/andrena/tools/macker/plugin/testclasses";
            ...
            throws Exception
    {
        ...
        AbstractMackerMojo mojo = (AbstractMackerMojo) lookupMojo( getMojoName(), testPom );
        assertNotNull( mojo );
        mojo.execute();
    }
    ...
    public void testNotFailOnViolationButBroken()
            throws Exception
    {
    ...
    public void testFailOnViolation()
            throws Exception
    {
        // POM configures a ruleset that fails on the given classes
    ...
    public void testIgnoreTestClasses()
            throws Exception
    {
    ...
    public void testFailInTestClasses()
            throws Exception
    {
        // POM configures a ruleset that fails on the given test classes
    ...
    public void testIgnoreMissingTestClassesWhenIncluded()
            throws Exception
    {
    ...
    public void testSingleRuleInList()
            throws Exception
    {
    ...
    public void testFailOnVariable()
            throws Exception
    {
        // POM configures a ruleset that fails on the given classes
