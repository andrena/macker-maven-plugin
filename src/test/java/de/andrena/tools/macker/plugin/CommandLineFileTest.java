...
import de.andrena.tools.macker.plugin.forked.SetArgs;
        ...
        extends TestCase
{
    ...
    public void testInvoke()
            throws Exception
    {
        CommandLineFile.main( new String[]
        { SetArgs.class.getName() } );
            ...
            throws Exception
    {
        ...
        CommandLineFile.main( new String[]
        { SetArgs.class.getName(), TEST_FILE.toString() } );
        assertNotNull( SetArgs.getLastArgs() );
        assertEquals( 0, SetArgs.getLastArgs().length );
    }
            ...
            throws Exception
    {
        ...
        writeArgsFile( Arrays.asList( new String[]
        { "aaa", CHEROKEE_LETTER_A, " tralala " } ) );
